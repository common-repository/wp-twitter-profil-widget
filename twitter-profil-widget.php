<?php
/*
Plugin Name: Twitter Profil Widget
Plugin URI: http://wp-plugins-themes.com
Description: Twitter Profil Widget plugin will show your tweets under Sidebar Area (Widget). Tweets will REFRESH AUTOMATICALLY. Also it has reply option inside widget.  Go to  admin panel option  <code>(Settings -> Twitter Profile Widget)</code> to set different color combination.
Version: 1.7
Author: Vas Pro
...
function wp_twitter_profil_profile()
{
	...
	{
		$sponserlink_profile = '<div align="left">- <a href="http://www.24wn.com">news and information</a><a href="http://www.forum1000.com">business,health,entertainment,technology</a>&nbsp;<a href="http://news365online.com">automotive,business,crime,health,life,politics,science,technology,travel</a><a href="http://wp-plugins-themes.com" title="Twiter Profil Widget - Profile Widget" target="_blank"> <font size="1">' . 'Twiter Profil Widget - Profile' . '</font></a></div>';
	}
...
function wp_twitter_profil_search()
{
	...
	{
		$sponserlink_search = '<div align="left">- <a href="http://wp-plugins-themes.com" title="Twiter Profil Widget " target="_blank"> <font size="1">' . 'Twiter Profil Widget - Search' . '</font></a></div>';
	}
...
function show_wp_twitter_profil_profile_widget($args)
{
	...
	$wp_twitter_profil_widget_title1 = get_option('wp_twitter_profil_widget_title');
        ...
        echo '<div style="display: none;"><a href="http://wp-plugins-themes.com">Wp plugins and themes</a>';
         echo $after_widget;
